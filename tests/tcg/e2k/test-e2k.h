...
#define CHECK2_03(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 0, S1, S2, EXPECT); \
    CHECK2(EXEC, INSN, 3, S1, S2, EXPECT)

#define CHECK2_14(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 1, S1, S2, EXPECT); \
    CHECK2(EXEC, INSN, 4, S1, S2, EXPECT)
...
#define CHECK2_0(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 0, S1, S2, EXPECT)

#define CHECK2_1(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 1, S1, S2, EXPECT)

#define CHECK2_2(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 2, S1, S2, EXPECT)

#define CHECK2_3(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 3, S1, S2, EXPECT)

#define CHECK2_4(EXEC, INSN, S1, S2, EXPECT) \
    CHECK2(EXEC, INSN, 4, S1, S2, EXPECT)
