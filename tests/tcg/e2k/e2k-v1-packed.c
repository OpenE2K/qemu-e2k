...
EXPECT_DATA(pandd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pandnd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pord, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pxord, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pminub, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pminsh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmaxub, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmaxsh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(paddb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(paddh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(paddsb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(paddsh, uint64_t, TEST_DATA_N) {
    0x000000001a465152, 0x0000000000024682, 0xffffffffffff0000, 0xffffffffffffffff,
    0xfffefffefffefffe, 0xffffffffffff0000, 0xffffffffffff0001, 0x7fffffffffffffff,
...
EXPECT_DATA(paddusb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(paddush, uint64_t, TEST_DATA_N) {
    0x000000001a46ffff, 0x0000000000024682, 0xffffffffffffffff, 0xffffffffffffffff,
    0xffffffffffffffff, 0xffffffffffffffff, 0xffffffffffffffff, 0x7fffffffffffffff,
    0x7fffffffffffffff, 0xffffffffffffffff, 0xffffffffffffffff, 0x8000000000000001,
    0xfffffffffffffffe, 0xffffffff1a46ffff, 0xffffffff00024682, 0xffffffffffffffff,
...
EXPECT_DATA(paddw, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(paddd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psubb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psubh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psubsb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psubsh, uint64_t, TEST_DATA_N) {
    0x000000000a225b9e, 0x0000000000000000, 0x0001000100034682, 0xffffffffffffffff,
    0x0000000000000000, 0xfffffffffffffffe, 0xfffffffffffffffd, 0x7fffffffffffffff,
...
EXPECT_DATA(psubusb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psubush, uint64_t, TEST_DATA_N) {
    0x000000000a220000, 0x0000000000000000, 0x0000000000000000, 0xffffffffffffffff,
    0x0000000000000000, 0xfffffffffffffffe, 0xfffffffffffffffd, 0x7fffffffffffffff,
    0x7ffffffffffffffe, 0x0000000000000000, 0x0000000000000000, 0x8000000000000000,
    0x0000000000000000, 0x000000000a220000, 0x0000000000000000, 0x0000000000000000,
...
EXPECT_DATA(psubw, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psubd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pcmpeqb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pcmpeqh, uint64_t, TEST_DATA_N) {
    0xffffffff00000000, 0xffffffffffffffff, 0x0000000000000000, 0x0000000000000000,
    0xffffffffffffffff, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
...
EXPECT_DATA(pcmpeqw, uint64_t, TEST_DATA_N) {
    0xffffffff00000000, 0xffffffffffffffff, 0x0000000000000000, 0x0000000000000000,
    0xffffffffffffffff, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000,
    0x0000000000000000, 0x00000000ffffffff, 0x0000000000000000, 0x0000000000000000,
    0x0000000000000000, 0x0000000000000000, 0x00000000ffffffff, 0x0000000000000000,
...
EXPECT_DATA(pcmpgtb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pcmpgth, uint64_t, TEST_DATA_N) {
    0x00000000ffffffff, 0x0000000000000000, 0xffffffffffffffff, 0x0000000000000000,
...
EXPECT_DATA(pcmpgtw, uint64_t, TEST_DATA_N) {
    0x00000000ffffffff, 0x0000000000000000, 0xffffffffffffffff, 0x0000000000000000,
...
EXPECT_DATA(pavgusb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pavgush, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(punpckhbh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(punpcklbh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(punpckhhw, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(punpcklhw, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(punpckhwd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(punpcklwd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmovmskps, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmovmskpd, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(packsshb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(packushb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(packsswh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmovmskb, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmulhh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmullh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmaddh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(pmulhuh, uint64_t, TEST_DATA_N) {
...
EXPECT_DATA(psadbw, uint64_t, TEST_DATA_N) {
